...
files = {
    "README.md": {
        "sync_from": "v0.9.5",
        "sync_to": "v0.9.6",
        "summary": "📢 <b>Latest Release: v0.9.6 (Login Warning Notice)</b> — Click to see what's new",
...
- **⬆️ Version Upgrade** — Updated all configuration and project files to `v0.9.6`."""
    ...
    "README.de.md": {
        "sync_from": "v0.9.5",
        "sync_to": "v0.9.6",
        "summary": "📢 <b>Neueste Version: v0.9.6 (Login-Warnung)</b> — Klicken für Neuerungen",
...
- **⬆️ Versions-Upgrade** — Aktualisierung aller Konfigurations- und Projektdateien auf `v0.9.6`."""
    ...
    "README.es.md": {
        "sync_from": "v0.9.5",
        "sync_to": "v0.9.6",
        "summary": "📢 <b>Última versión: v0.9.6 (Advertencia de inicio de sesión)</b> — Haz clic para ver las novedades",
...
- **⬆️ Actualización de versión** — Se actualizaron todos los archivos de configuración y proyecto a la versión `v0.9.6`."""
    ...
    "README.fr.md": {
        "sync_from": "v0.9.5",
        "sync_to": "v0.9.6",
        "summary": "📢 <b>Dernière version : v0.9.6 (Avertissement de connexion)</b> — Cliquez pour voir les nouveautés",
...
- **⬆️ Mise à niveau de version** — Mise à jour de tous les fichiers de configuration et de projet vers la version `v0.9.6`."""
    ...
    "README.ja.md": {
        "sync_from": "v0.9.5",
        "sync_to": "v0.9.6",
        "summary": "📢 <b>最新リリース: v0.9.6 (ログイン警告通知)</b> — クリックで変更点を表示",
...
- **⬆️ バージョンアップグレード** — すべての設定およびプロジェクトファイルを `v0.9.6` に更新しました。"""
    ...
    "README.pt-BR.md": {
        "sync_from": "v0.9.5",
        "sync_to": "v0.9.6",
        "summary": "📢 <b>Última versão: v0.9.6 (Aviso de login)</b> — Clique para ver as novidades",
...
- **⬆️ Atualização de versão** — Atualizados todos os arquivos de configuração e do projeto para `v0.9.6`."""
    ...
    "README.zh-CN.md": {
        "sync_from": "v0.9.5",
        "sync_to": "v0.9.6",
        "summary": "📢 <b>最新版本：v0.9.6 (登录警告提示)</b> —— 点击查看更新内容",
