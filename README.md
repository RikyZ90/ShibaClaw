...
📢 **Welcome to ShibaClaw v0.3.2!** This release adds a brand new **Native Windows Desktop App**, cross-provider model search, true per-session model routing, a redesigned model-first settings flow, and OpenRouter OAuth directly in the WebUI.
